...
<div class="flex justify-center items-center h-screen bg-base-200">
  <div class="w-full p-8 m-auto bg-base-100 rounded-lg shadow-lg lg:max-w-md lg:w-full">
    ...
    <form class="space-y-6 mt-4" on:submit={handleLogin}>
      ...
      <div>
        <label for="password" class="block text-base-content font-medium">Password</label>
        <input 
          type="password" 
          id="password"
          bind:value={password}
          ...
          class="w-full mt-1 px-4 py-2 border border-base-300 rounded-md focus:ring-2 focus:ring-green-500 focus:outline-none bg-base-100 text-base-content"
        />
        <a href="/forgot-password" class="text-sm text-green-500 hover:underline block mt-2 text-right">Forgot Password?</a>
      </div>
      ...
      <div class="flex items-center">
        <input type="checkbox" id="rememberMe" class="checkbox checkbox-success" />
        <label for="rememberMe" class="ml-2 text-sm text-base-content">Remember Me</label>
      </div>

      <div>
        <button type="submit" class="w-full px-4 py-2 text-white bg-green-600 rounded-md hover:bg-green-700 transition">
          Sign In
        </button>
      </div>
      ...
      <p class="text-sm text-center text-base-content">
        ...
        <a href="/register" class="text-green-500 font-bold hover:underline">Sign up</a>
      </p>
    </form>
  </div>
</div>
